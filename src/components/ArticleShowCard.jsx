...
const ArticleShowCard = ({article}) => {
  ...
  return (
    <article className= "article"> 
      ...
      <p className= 'article-item article-info'>Topic: <span className='article-topic-wrapper'>{topic}</span></p>
       <p className = "article-item article-info">Author: <span className = 'article-author'>{author}</span></p> 
       <div className='article-item article-sort-section'>
          ...
          <p className='article-timestamp'>{moment.utc(created_at).format('MMMM D, YYYY h:mm A')}</p>
        </div>
    </article>
